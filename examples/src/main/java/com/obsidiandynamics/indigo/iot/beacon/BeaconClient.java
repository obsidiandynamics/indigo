...
public final class BeaconClient {
  private static final String HOST = get("flywheel.beacon.host", String::valueOf, "localhost");
  private static final int PORT = get("flywheel.beacon.port", Integer::valueOf, 8080);
  private static final String CONTEXT_PATH = get("flywheel.beacon.contextPath", String::valueOf, "/beacon");
